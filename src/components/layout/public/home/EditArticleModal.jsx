...
export default function EditArticleModal({ article: articleToEdit, onSave, onCancel, onUpdateSucess }) {
    ...
    const { article, loading: loadingArticle, error: errorArticle } = useArticle(articleToEdit?.id, articleToEdit?.slug);
    const { categories, loading: loadingCategories, error: errorCategories } = useCategories();
    ...
    // const [isPremium, setIsPremium] = useState(false); // VIP comentado
